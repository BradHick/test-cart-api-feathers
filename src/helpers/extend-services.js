class Service {
  ...
  setup(app) {
    ...
    this.service.on('created', (data) => this.emit('created', data));
    this.service.on('updated', (data) => this.emit('updated', data));
    this.service.on('patched', (data) => this.emit('patched', data));
    this.service.on('removed', (data) => this.emit('removed', data));
  }
